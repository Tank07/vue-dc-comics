<template>
  <div class=" bg_black">
    ...
    <div class="container">
      ...
      <span class="bg-primary py-2 px-3 text-start text-white fw-bold">Current Series</span>
    ...
    <button type="button" class="btn btn-primary my-2 text-center">Load More</button>  
...
import BlackProps from "./BlackProps.vue"
